...
// Emotes
//#define CAT SEND_STRING(":3")
//#define hCAT SEND_STRING(">:3")
//#define bCAT SEND_STRING("://3")
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, DblClik, KC_LEFT,KC_DOWN, KC_RIGHT,A(KC_DOWN),                    S(KC_8),    KC_1,    KC_2,    KC_3,S(KC_EQL), KC_DOT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX, B_UNDO,S(C(KC_TAB)),B_COPY,C(KC_TAB),B_PASTE,                    KC_SCLN,  S(KC_0), KC_RBRC, S(KC_RBRC), _______, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     A(KC_3),S(KC_7),S(KC_BSLS),S(KC_EQL),S(KC_0),S(KC_5),                   S(KC_3),KC_NUBS,S(KC_NUBS),S(KC_SCLN),S(KC_SLSH),KC_BSLS,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                              Nav, KC_LSFT,  KC_ENT,     KC_ENT,KC_SPACE,   Sym
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,                      XXXXXXX,   KC_F7,   KC_F8,   KC_F9,  KC_F12, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
